...
public class ExemploTest {
     ...
     */
    private static String CHROMEDRIVER_LOCATION = "C:\\Users\\Tiago.DESKTOP-1Q9EAE0\\Desktop\\Selenium\\chromedriver.exe";
    ...
    public void testComboBox() {
        ...
        WebDriver driver = new ChromeDriver();
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        driver.get("http://www2.correios.com.br/sistemas/precosPrazos/");
        Select select = new Select(driver.findElement(By.name("servico")));
        select.selectByVisibleText("PAC");
        driver.close();
}
